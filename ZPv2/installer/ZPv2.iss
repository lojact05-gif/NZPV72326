...
Filename: "{sys}\sc.exe"; Parameters: "create ""ZPv2Service"" binPath= ""{app}\ZPv2.Service.exe"" start= auto DisplayName= ""ZPv2 Service"""; Flags: runhidden ignoreerrors
Filename: "{sys}\sc.exe"; Parameters: "config ""ZPv2Service"" binPath= ""{app}\ZPv2.Service.exe"" start= auto DisplayName= ""ZPv2 Service"""; Flags: runhidden ignoreerrors
Filename: "{sys}\sc.exe"; Parameters: "description ""ZPv2Service"" ""ZPv2 local API and thermal print service"""; Flags: runhidden ignoreerrors
Filename: "{sys}\sc.exe"; Parameters: "start ""ZPv2Service"""; Flags: runhidden ignoreerrors
